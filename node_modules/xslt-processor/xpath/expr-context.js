...
var ExprContext = /** @class */ (function () {
     ...
     */
    function ExprContext(nodeList, outputNodeList, opt_position, opt_outputPosition, opt_outputDepth, opt_decimalFormatSettings, opt_variables, opt_knownNamespaces, opt_parent, opt_caseInsensitive, opt_ignoreAttributesWithoutValue, opt_returnOnFirstMatch, opt_ignoreNonElementNodesForNTA) {
    ...
    ExprContext.prototype.clone = function (opt_nodeList, opt_outputNodeList, opt_position, opt_outputPosition) {
        return new ExprContext(opt_nodeList || this.nodeList, opt_outputNodeList || this.outputNodeList, typeof opt_position !== 'undefined' ? opt_position : this.position, typeof opt_outputPosition !== 'undefined' ? opt_outputPosition : this.outputPosition, this.outputDepth, this.decimalFormatSettings, this.variables, this.knownNamespaces, this, this.caseInsensitive, this.ignoreAttributesWithoutValue, this.returnOnFirstMatch, this.ignoreNonElementNodesForNTA);
    };
    ExprContext.prototype.cloneByOutput = function (opt_outputNodeList, opt_outputPosition, opt_outputDepth) {
        return new ExprContext(this.nodeList, opt_outputNodeList || this.outputNodeList, this.position, typeof opt_outputPosition !== 'undefined' ? opt_outputPosition : this.outputPosition, typeof opt_outputDepth !== 'undefined' ? opt_outputDepth : this.outputDepth, this.decimalFormatSettings, this.variables, this.knownNamespaces, this, this.caseInsensitive, this.ignoreAttributesWithoutValue, this.returnOnFirstMatch, this.ignoreNonElementNodesForNTA);
    };
